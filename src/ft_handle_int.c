...
{
	long long	n; //To store the value of the next argument retrieved from `ap` for processing. `long long` because it allows for the storage of a wider range of integer values compared to `int`
