...
int	ft_handle_char(va_list ap) //`ap` is a v`a_list` pointer that is passed as an argument. Inside the function, this pointer is used to access the variable arguments
{
